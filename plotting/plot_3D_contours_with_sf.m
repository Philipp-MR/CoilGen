...
for part_ind=1:numel(coil_layout(single_ind_to_plot).out.coil_parts)
    ...
    plot3(  coil_layout(single_ind_to_plot).out.coil_parts(part_ind).groups(group_ind).loops(contour_ind).point_coordinates(1,:)...
                ,coil_layout(single_ind_to_plot).out.coil_parts(part_ind).groups(group_ind).loops(contour_ind).point_coordinates(2,:)...
                ,coil_layout(single_ind_to_plot).out.coil_parts(part_ind).groups(group_ind).loops(contour_ind).point_coordinates(3,:),'color','k','linewidth',2);
    end
    end
    end
end
